...
if (len(sys.argv) != 2 ):
	print "get_HGT_from_cuscuta2rosids_v3.1.py <newick_trees_dir>"
	exit()
...
##########################################################################################
		...
		for row in evts:
			...
			if (len(left) > 0 and len(right) > 0):
				...
				if (Cpent_left >0 and Cpent_right >0 and asterid_left ==0 and asterid_right ==0 and mono_left ==0 and mono_right ==0 and basal_left==0 and basal_right==0 and ancient_left==0 and ancient_right==0) or (Cpent_left >0 and Cpent_right ==0 and asterid_left ==0 and asterid_right ==0 and mono_left ==0 and mono_right ==0 and ancient_left==0 and ancient_right==0 and basal_left==0 and basal_right==0) or (Cpent_left ==0 and Cpent_right >0 and asterid_left ==0 and asterid_right ==0 and mono_left ==0 and mono_right ==0 and basal_left==0 and basal_right==0 and ancient_left==0 and ancient_right==0):
					#print "yes"
