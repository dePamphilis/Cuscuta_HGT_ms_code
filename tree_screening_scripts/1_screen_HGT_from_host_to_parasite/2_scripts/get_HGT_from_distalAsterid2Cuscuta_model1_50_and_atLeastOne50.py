                        ...
                        if len(Cpent_list) ==1:
                            ...
                            if int(node1.support) >= 50:
                                ...
                                if bs_count >=1:
                                    ...
                                    if not node2nd_max == "":
                                        print "The 2nd highly supported node consisting the Cuscuta gene and distal asterid donor is " + str(node2nd_max.support) + " with the node shown as:"
                                        print node2nd_max
                                ...
                                if len(ances_dict.keys())>=3:
                                    ...
                                    if bs_count >1:
                                        ...
                                        if not node2nd_max == "":
                                            print "The 2nd highly supported node consisting the distal asterid donor is " + str(node2nd_max.support) + " with the node shown as:"
                                            print node2nd_max
