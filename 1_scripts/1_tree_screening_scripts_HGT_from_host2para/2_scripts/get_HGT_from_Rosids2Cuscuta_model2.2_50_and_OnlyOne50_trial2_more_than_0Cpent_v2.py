                            ...
                            if int(node1.support) >= 50:
                                ...
                                if len(ances_dict.keys())>=3:
                                    ...
                                    if bs_count ==1:
                                        ...
                                        if not node2nd_max == "":
                                            print "The 2nd weakly supported node consisting the rosid gene and rosid  donor is " + str(node2nd_max.support) + " with the node shown as:"
                                            print node2nd_max
                                ...
                                if int(node1.support) >= 50:
                                    ...
                                    if len(ances_dict.keys())>=3:
                                        ...
                                        if bs_count ==1:
                                            ...
                                            if not node2nd_max == "":
                                                print "The 2nd weakly supported node consisting the Cuscuta gene and rosid donor is " + str(node2nd_max.support) + " with the node shown as:"
                                                print node2nd_max
