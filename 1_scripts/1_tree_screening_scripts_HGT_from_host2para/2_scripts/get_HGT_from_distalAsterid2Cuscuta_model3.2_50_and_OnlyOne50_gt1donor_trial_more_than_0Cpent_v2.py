...
##########################################################################################
        ...
        for row in evts:
            ...
            if (len(left) > 0 and len(right) > 0):
                ...
                if (dist_asterid_left>0 and dist_asterid_right ==0 and rosid_left ==0 and rosid_right ==0  and asterid_left==0 and asterid_right ==0 and ancient_left ==0 and ancient_right ==0 and basal_left==0 and basal_right==0 and mono_left==0 and mono_right==0 )  or (dist_asterid_left ==0 and dist_asterid_left >0 and rosid_left ==0 and rosid_right ==0 and asterid_left==0 and asterid_right ==0 and ancient_left ==0 and ancient_right ==0 and basal_left==0 and basal_right==0 and mono_left==0 and mono_right==0 ) or (dist_asterid_left >0 and dist_asterid_left >0 and rosid_left ==0 and rosid_right ==0 and asterid_left==0 and asterid_right ==0 and ancient_left ==0 and ancient_right ==0 and basal_left==0 and basal_right==0 and mono_left==0 and mono_right==0 ): 
                        ...
                        if len(Cpent_list) ==1:
                            ...
                            if int(node1.support) >= 50:
                                ...
                                if bs_count ==1:
                                    ...
                                    if max_value <50 and max_value >1:
                                        print "Orthogroup number: " + ortho + " has the big node shown as:"
                                        print ancestor_1
                                        print "the node1 support consisting the Cuscuta gene and distal asterid donor is " + str(node1.support) + " with the node shown as:"
                                        print node1
                                            ...
                                            if interior_dict[i] is None:
                                                ...
                                                if node in ancestor_1 or node == ancestor_1:
                                                    if node.support == max_value:
                                                        ...
                                                        node2 = node
                                                        try:
                                                            node2_value = node2.support
                                                        except:
                                                            pass
                                        print "the 2nd node weakly supporting the grouping of distal asterid clade is " + str(node2_value) + " with the node shown as:"
                                        print node2
