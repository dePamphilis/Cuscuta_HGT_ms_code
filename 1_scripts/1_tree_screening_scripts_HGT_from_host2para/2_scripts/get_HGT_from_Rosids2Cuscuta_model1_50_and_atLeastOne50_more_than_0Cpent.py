...
if (len(sys.argv) != 2 ):
	print "get_HGT_from_rosids2cuscuta.py <newick_trees_dir>"
	exit()
...
##########################################################################################
        ...
        for row in evts:
            ...
            if (len(left) > 0 and len(right) > 0):
                ...
                if (rosid_left >0 and rosid_right >0 and asterid_left ==0 and asterid_right ==0 and ancient_left ==0 and ancient_right ==0 and basal_left==0 and basal_right==0 and mono_left==0 and mono_right==0 ) :                    #print "yes"
                    if (Cpent_left >0 and Cpent_right ==0) or (Cpent_right >0 and Cpent_left ==0) or (Cpent_left >0 and Cpent_right >0):
                        # if the node has only 1 Cuscuta gene
                        ...
                        if len(Cpent_list) ==1:
                                            ...
                                            if ances_dict[i] is None:
                                                ...
                                                if node in ancestor_1 or node == ancestor_1:
                                                    ...
                                                    try:
                                                        ...
                                                        pass
                                    print "The 1st highly supported node consisting the Cuscuta gene and rosid donor is " + str(node_max.support) + " with the node shown as:"
                                    print node_max

                                    if not node2nd_max == "":
                                        print "The 2nd highly supported node consisting the Cuscuta gene and rosid donor is " + str(node2nd_max.support) + " with the node shown as:"
                                        print node2nd_max
                                        

                                #although the first node containing Cuscuta has node support value less than 50, as long as two of the interior nodes are strong, it is a valid HGT
                                                ...
                                                if ances_dict[i] is None:
                                                    ...
                                                    if node in ancestor_1 or node == ancestor_1:
                                                        ...
                                                        try:
                                                            ...
                                                            pass
                                        print "The 1st highly supported node consisting the Cuscuta gene and eudicot donor is " + str(node_max.support) + " with the node shown as:"
                                        print node_max
                                        
                                        if not node2nd_max == "":
                                            print "The 2nd highly supported node consisting the rosid  donor is " + str(node2nd_max.support) + " with the node shown as:"
                                            print node2nd_max
                            ...
                            for Cp_i in range(0, Cpent_num):
                                #if node1 only contains Cuscuta genes, then node1 has to go up until it has a non-Cuscuta leaf
